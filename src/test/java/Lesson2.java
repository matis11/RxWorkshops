...
public class Lesson2 {
    ...
    public void _2_flatMapUnwrapsOneLevelOfNestingInAnObservableStream() {
         ...
         */
        List<LessonResources.CarnivalFood> funnelCakeCart;
        funnelCakeCart = Arrays.asList(new LessonResources.CarnivalFood("Cheese Pizza", 5.95),
         ...
         */
        Observable<Observable<LessonResources.CarnivalFood>> map = foodCartItemsObservable.map(new Func1<List<LessonResources.CarnivalFood>, Observable<LessonResources.CarnivalFood>>() {
            @Override
            public Observable<LessonResources.CarnivalFood> call(List<LessonResources.CarnivalFood> foods) {
                Observable<LessonResources.CarnivalFood> from = Observable.from(foods);
                return from;
            }
        });
         ...
         */
        Observable<LessonResources.CarnivalFood> individualItemsObservable = foodCartItemsObservable.flatMap(new Func1<List<LessonResources.CarnivalFood>, Observable<LessonResources.CarnivalFood>>() {
            @Override
            public Observable<LessonResources.CarnivalFood> call(List<LessonResources.CarnivalFood> foods) {
         ...
         */
        individualItemsObservable.filter(new Func1<LessonResources.CarnivalFood, Boolean>() {
            @Override
            public Boolean call(LessonResources.CarnivalFood food) {
    ...
    public void _3_theReduceOperatorAccumulatesValuesAndEmitsTheResult() {
        ...
        Observable<LessonResources.ElevatorPassenger> elevatorPassengersObservable = Observable.from(elevatorPassengers);
        /**
